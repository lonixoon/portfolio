...
/* ============ ТАСК "SASS" ========================================================================================= */
    ...
    gulp.task('sass', function() {
        ...
        return gulp.src(cfg.paths.src.sass)                         // Выбираем основной файл scss
            .pipe(plumber(err))                                     // Отслеживаем ошибки
...
/* ============ ТАСК "LIB" ======================================================================================== */
    ...
    gulp.task('lib', function() {
        console.log('---------- Копирование библиотек');
        return gulp.src(cfg.paths.src.lib)
            .pipe(gulp.dest(cfg.paths.build.lib))
...
/* ============ ТАСК "SVG" ======================================================================================== */
    ...
    // Копирование SVG спрайта (нужно настроть нормальную сборку)
    gulp.task('svg', function() {
        console.log('---------- Копирование SVG спрайта');
        return gulp.src(cfg.paths.src.svg)
            .pipe(gulp.dest(cfg.paths.build.svg))
            .pipe(reload({stream: true}));
    });
/* ================================================================================================================== */
